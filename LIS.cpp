...
int main()
{
	...
	long arraySize;
	// ввод размера входного массива
	std::cin >> arraySize;

	int *x = new int[arraySize]; // входной массив
	int *index = new int[arraySize]; // длина префикса для каждого элемента входного массива

	// ввод входного массива
